...
public class BusNotEvenNumberComparatorImpl implements SomeComparator<Bus> {

    /**
     * Компаратор для сравнения только тех Автобусов, у которых Номер маршрута нечетный
