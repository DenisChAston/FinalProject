...
public class StudentNotEvenGroupComparatorImpl implements SomeComparator<Student> {

    /**
     * Компаратор для сравнения только тех Студентов, у которых Номер группы нечетный
